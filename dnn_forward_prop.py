...
def linear_forward(A, W, b, keep_prob=1):
    """
...
def linear_activation_forward(A_prev, W, b, activation, keep_prob=1):
    ...
    if activation == "sigmoid":
        ...
        # Inputs: "A_prev, W, b". Outputs: "A, activation_cache".
        Z, linear_cache = linear_forward(A_prev, W, b, keep_prob=keep_prob)
...
def L_model_forward(X, parameters, keep_prob=1):
    ...
    for l in range(1, L):
        A_prev = A 
        A, cache = linear_activation_forward(A_prev, parameters['W' + str(l)], parameters['b' + str(l)], activation = "relu", keep_prob=keep_prob)
        caches.append(cache)
